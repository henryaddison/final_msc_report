\chapter{Model}
  ...
  \section{Overview}
    ...
    \section{Boat}
      ...
      \subsection{Simplified Model}
      For modelling purposes the boat is the object that is bound by physical constraints such as being on the river. It is also the object that has a location and moves according to its speed and orientation. Without action by the cox a boat will continue to follow the lane it is in at it current speed.
