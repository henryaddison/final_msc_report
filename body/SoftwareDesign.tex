...
This ends the description of the software behind the simulation and some possible future improvements. More detail is available in the source code but hopefully this chapter gives an interested reader an idea of where to start looking. The next chapter describes the logic used to create the control policies.
