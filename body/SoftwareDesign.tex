...
\paragraph{Better visualization}
\paragraph{Interactive demo mode}
\paragraph{Match model more closely}
\paragraph{Optimized observation code so policies can have a memory}
...
\paragraph{allow changing of lanes when midway through a lane change}
