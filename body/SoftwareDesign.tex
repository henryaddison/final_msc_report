...
each crash. More interesting than a code is the data and the best
way to examine that is to look at the database schema.
...
The database schema is visualized in the Figure \ref{software:fig:db_eer}.

\begin{figure}
\begin{center}
  \includegraphics[scale=0.3]{images/db_eer.png}
  \caption{EER model of database}
  \label{software:fig:db_eer}
\end{center}
\end{figure}
